...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 597.0, 544.0, 35.0, 22.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 34.0, 135.0, 722.0, 87.0 ],
					"text" : "First try out the patch by clicking on \"play a note\" after adjusting some of the settings. Finally fill up the preset object with intriguing new presets."
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 1559.63302752293589, 0.984375, 0, 4128.440366972477023, 0.625, 0, 4954.128440366972427, 0.28125, 0, 7706.422018348624078, 1.0, 0, 8807.339449541284921, 0.234375, 0, 10000.0, 0.0, 0 ],
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 183.486238532110093, 21.75, 0, 2568.807339449541359, 0.0, 0, 4770.642201834862135, 24.0, 0, 6330.275229357797798, 0.0, 0, 8256.880733944954045, 23.25, 0, 10000.0, 0.0, 0 ],
					"bgcolor" : [ 0.8, 0.8, 0.8, 1.0 ],
					"domain" : 10000.0,
					"gridcolor" : [ 0.5, 0.5, 0.5, 0.5 ],
					"id" : "obj-109",
