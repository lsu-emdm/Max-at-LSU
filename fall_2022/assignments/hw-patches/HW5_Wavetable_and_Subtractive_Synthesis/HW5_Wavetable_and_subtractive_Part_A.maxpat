...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.363647000000014, 453.0, 59.0, 33.0 ],
					"text" : "0Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1189.545409999999947, 453.0, 111.0, 33.0 ],
					"text" : "22050Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 963.0, 473.636352999999986, 173.0, 33.0 ],
					"text" : "Frequency [Hz]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 757.0, 352.5, 125.0, 33.0 ],
					"text" : "Magnitude"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 876.0, 300.5, 366.0, 150.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 215.0, 391.0, 117.0, 33.0 ],
					"text" : "Amplitude"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 85.5, 171.0, 98.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 36.0, 171.0, 50.0, 22.0 ],
					"textcolor" : [ 1.0, 0.096669, 0.233883, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 11.0, 318.0, 33.0 ],
					"text" : "If you reduce the number of bits used to store an audio waveform, then the audio waveform becomes distorted."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 205.0, 62.0, 20.0 ],
					"text" : "Bit Depth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 144.0, 34.0, 22.0 ],
					"text" : "mtof"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 36.0, 117.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 36.0, 57.0, 336.0, 53.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 441,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 282.0, 370.0, 270.0 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 125.0, 273.0, 44.0, 120.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 125.0, 235.0, 62.0, 22.0 ],
					"text" : "degrade~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 36.0, 198.0, 72.0, 22.0 ],
					"text" : "cycle~ 400."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 481.0, 552.0, 70.0, 33.0 ],
					"text" : "Time"
				}
